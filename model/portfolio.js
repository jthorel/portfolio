...
var Portfolio = function() {
	...
	this.projects = [
		{	
			...
			title: "black friday",  
			thumb: "splash3.png", 
			shortdesc: "A competitive top-down pixel-art action local multiplayer game developed in Unity3D for PC and Mac",
		...
		{	
			...
			title: "braking point",  
			thumb: "braking.png", 
			shortdesc: "Split screen car game on breakable ice, created in Unreal Engine during Nordic Game Jam 2018",
		...
		{	
			...
			thumb: "exjobb.jpg", 
			shortdesc: "Master thesis project. Created a VR prototype for collaborative planning of high speed railway with user studies. Made in Unreal Engine",
			desc: "Master thesis project. Created a VR prototype for collaborative planning of high speed railway with user studies. Made in Unreal Engine",
		...
		{	
			...
			title: "kälk-nisse",  
			thumb: "kalk1.png", 
			shortdesc: "AR game prototype created in ARKit for iOS. Draw lines on paper and ride them with your character.",
		...
		},
		{
			...
			thumb: "katt.gif", 
			shortdesc: "Bachelor thesis. Iphone app utilizing spatial sound from GPS positions as direction for navigation, with user testing.",
			...
			images: ["katt.gif"],
			link: {url: "https://github.com/jthorel/Waypoint-tracker", text:"Source code on Github"}
		...
		},
		{
			...
			shortdesc: "VR game developed in Unity. Presented and tested at several exhibitions.",
			desc: "VR game developed in Unity. Presented and tested at several exhibitions.",
			tags: ["Unity3D", "Game Design", "Virtual Reality", "Advanced Graphics", "Interaction"],
			images: [],
			videos: ["labyrinth"],
		...
		},
		{
			...
			title: "activities", 
			thumb: "act1.png",
			shortdesc: "Mobile web app for creating activities. Other nearby users can join using geolocation.",
		...
		},
		{
			...
			shortdesc: "Design prototype for a new bus commute planning app in Stockholm, specifically for users with a baby stroller.",
...

		{
			...
			title: "kopps",
			thumb: "kopps.png",  
			shortdesc: "Redesign of a course planning system with an interactive prototype, with user studies.",
			desc: "Redesign of a course planning system with an interactive prototype",
			tags: ["Interaction Design", "Prototyping", "UX", "HTML5", "JavaScript", "CSS", "Balsamiq"],
			images: ["kopps.png"],
			link: {url: "http://xml.csc.kth.se/~jthorel/ixd-metod/prototyp/schedule_fin.html",
					text: "Test prototype"}
		},
		...
		},
		{
			...
			title: "quiz web app", 
			thumb: "olquiz.jpg",
			shortdesc: "A quiz web app created for the student union paper. Modular, statistics, cloud-backend and built for ease of modification for different quizes. Made with React and Redux",
			desc: "",
			tags: ["React", "Redux", "HTML5", "CSS", "JavaScript"],
			link: {url: "https://quiz.osqledaren.se", text: "Take the quiz (swedish)"},
			images: ["olquiz.jpg"],
		},
		{
			id: 10, 
			title: "bertil", 
			thumb: "bertil.png",
			shortdesc: "A smart water bottle that tracks water intake and reminds you to drink. A physical prototype created with a water bottle, arduino and sensors",
			...
			tags: ["Arduino", "C++", "Physical interaction", "HTML5", "CSS", "JavaScript"],
			images: ["bertil.png"],
			videos: ["bertil"]
		},
		{
		...
		for(var i in this.projects){
			if(this.projects[i].id == id){
				...
				if(this.projects[i].comments.length < 1){
					...
					var newid = this.projects[i].comments[this.projects[i].comments.length-1].id+1
					commentObj.id = newid;
					this.projects[i].comments.push(commentObj);
					break;
				}
